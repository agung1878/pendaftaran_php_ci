                            ...
                            <div class="col-12">
                                <div class="card-box">
                                    ...
                                    <form action="<?php base_url('newMhsController/tambah') ?>" method="POST" enctype="multipart/form-data">
                                        <input type="hidden" name="input_id" value="<?php echo uniqid(); ?>">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-10">
                                                <input class="form-control" type="date" name="input_tgl_lahir" value="<?php echo set_value('input_tgl_lahir'); ?>" id="tglLahir">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label for="example-email-input" class="col-2 col-form-label">No. Telepon</label>
                                            <div class="col-10">
                                                <input class="form-control" type="text" name="input_telp" value="<?php echo set_value('input_telp'); ?>" id="noTlp">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label for="example-email-input" class="col-2 col-form-label">Email</label>
                                            <div class="col-10">
                                                <input class="form-control"  type="email" name="input_email" value="<?php echo set_value('input_email'); ?>" id="email">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label for="example-text-input" class="col-2 col-form-label">Nama Orang Tua / Wali</label>
                                            <div class="col-10">
                                                <input class="form-control"  type="text" name="input_nama_org_tua" value="<?php echo set_value('input_nama_org_tua'); ?>" id="namaOrgTua">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label for="example-text-input" class="col-2 col-form-label">Asal Sekolah</label>
                                            <div class="col-10">
                                                <input class="form-control" type="text" name="input_asal_sekolah" value="<?php echo set_value('input_asal_sekolah'); ?>" id="asalSekolah">
                                            </div>
                                        </div>
                                        <div class="form-group row">
